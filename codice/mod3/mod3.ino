...
int buttonPins[] = {22, 24, 26, 28, 30, 32, 34, 36, 38, 40};
int ledPins[] = {23, 25, 27, 29, 31, 33, 35, 37, 39, 41};
int serialLcdPins[] = {2, 3, 4, 5};
int multiplexer1[] = {7, 8, 9};
int multiplexer2[] = {10, 11, 12};
int countdown = 10000;
int lastNumber = -1;
int currentNumber = -1;
int score = 0;
